...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Build scene asset paths and run branch sync')
    parser.add_argument('--paths', required=True, help='Scene names or paths')
